...
void each_dungeon_text(){
    ...
    printf("Перед тобой развилка на три пещеры, что будешь делать?\n");
    printf("Пойти влево - 1, пойти вправо - 2, открыть инвентарь - 3, сохраниться - 4, загрузить сохранение - 5\n");
}
